...
-- Since COUNT (above) and DISTINCT COUNT are both 6,547,094 This lets us verify that there are no duplicates.
...
-- number of rides with bikes not moving from start to end long/lat: 337,598 (this data will be cleaned)
